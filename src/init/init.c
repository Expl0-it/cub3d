...
/*   Updated: 2025/02/25 19:24:00 by mamichal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool init_mlx(t_game *game)
{
	...
	if (NULL == game->mlx_s.img)
		return (false);
	game->mlx_s.data = mlx_get_data_addr(game->mlx_s.img, &game->mlx_s.init.bits, \
		&game->mlx_s.init.len, &game->mlx_s.init.endian);
